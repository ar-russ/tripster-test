...
Получение N публикаций, отсортированных по дате создания, начиная с самых последних

| Метод | URL            | Нужна авторизация |
|-------|----------------|-------------------|
| GET   | /posts/latest  | Нет               |

Параметры:
- amount: Кол-во публикаций, которые нужно вывести. По умолчанию 10

#### · Получение лучших публикаций
Получение N публикаций, отсортированных по рейтингу, начиная с самых лучших
